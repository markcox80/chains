...
var org_html_manager = {
  ...
  {
      this.current_style_sheet++;
      switch (this.current_style_sheet % 2) {
      case 0:
	  document.getElementById('pagestyle').setAttribute('href', 'solarized-light.css');
	  break;
      case 1:
	  document.getElementById('pagestyle').setAttribute('href', 'solarized-dark.css');
	  break;
      }
  },
  ...
  build: function ()
  {
    ...
    for(var i = 0; i < this.SECS.length; ++i)
    {
      ...
      var html = '<table class="org-info-js_info-navigation" width="100%" border="0" style="border-bottom:1px solid black;">'
        ...
        + this.LINKS
        +'<a accesskey="m" href="javascript:org_html_manager.toggleView('+i+');">toggle view</a>'
        +' / '
	+'<a accesskey="z" href="javascript:org_html_manager.swapStyleSheet()">toggle CSS</a>'
        +'</span></td></tr><tr><td style="text-align:left;border-style:none;vertical-align:bottom;width:22%">';
      ...
      this.SECS[i].BUTTONS.innerHTML = '<div class="org-info-js_header-navigation" style="display:inline;float:right;text-align:right;font-size:70%;font-weight:normal;">'
        ...
        + '<a accesskey="m" href="javascript:org_html_manager.toggleView('+i+');">toggle view</a>'
	+ ' / '
        + '<a accesskey="z" href="javascript:org_html_manager.toggleView('+i+');">toggle CSS</a>'
	+ '</div>';
...
#+ORGTBL: SEND Shortcuts orgtbl-to-generic :splice t :skip 2 :lstart "\t+'<tr>" :lend "</tr>'" :fmt (1 "<td><code><b>%s</b></code></td>" 2 "<td>%s</td>") :hline "\t+'</tbody><tbody>'"
	...
	+'<tr><td><code><b>z</b></code></td><td>Toggle which CSS to use.</td></tr>'
	+'</tbody><tbody>'
