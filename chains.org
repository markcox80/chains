...
within a ~DEFINE-DOCUMENT~ block. The following is an example document
...
#+end_src
Thus there exists an instance of the block
...
To encourage reuse of designs, a special block ~(:design name)~
